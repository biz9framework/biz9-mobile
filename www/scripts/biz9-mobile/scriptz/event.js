    ...
    function bind_category_list(item_list,page_current,page_count){
        ...
        for(var a=0;a<item_list.length;a++){
            ...
            str=str+"<div class='col-6'>"+
                "<a href='event_list.html?category="+item.title+"&page_current=1'><div class='card card-style m-0 mb-2 rounded-m' style='background-image: url("+item.photo_obj.mid_url+")' data-card-height='90'>"+
