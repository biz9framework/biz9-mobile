        ...
        function bind_buy_event_slide_show(data){
            ...
            for(var a=0;a<data.card_buy_list.length;a++){
                ...
                str = str+"</div>"+
                    ...
                    "</div>"+
                    "</div>"+
                    "<span class='biz_sp_buy'><a id='biz_btn_cart_add_"+item.tbl_id+"' tbl_id='"+item.tbl_id+"'  data_type='"+item.data_type+"' href='#' class='btn btn-sm btn-full " +data.mobile.primary.button_color + " font-700 btn-margins rounded-sm mt-3 shadow-xl biz_btn_buy_now_button biz_btn'>Add To Cart</a></span>";
                if(item.app_store_product=='true'){
                    str = str+"<span class='biz_sp_checkout'><a href='#' biz_product_id='"+item.app_store_product_id+"' class='biz_btn_checkout btn btn-sm btn-full " +data.mobile.primary.button_color + " font-700 btn-margins rounded-sm mt-3 shadow-xl biz_btn'>Buy Now With 1-Click</a></span>";
                }
                str = str+"</div>";
