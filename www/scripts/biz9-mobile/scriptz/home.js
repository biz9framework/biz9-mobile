    ...
    function bind_buy_card(data){
        ...
        for(var a=0;a<data.card_buy_list.length;a++){
            ...
            str = str+"</div>"+
                ...
                "<span class='biz_sp_buy'><a id='biz_btn_cart_add_"+data.card_buy_list[a].tbl_id+"' tbl_id='"+data.card_buy_list[a].tbl_id+"'  data_type='"+data.card_buy_list[a].data_type+"' href='#' class='btn btn-sm btn-full " +data.mobile.primary.button_color + " font-700 btn-margins rounded-sm mt-3 shadow-xl biz_btn_buy_now_button biz_btn'>Add To Cart</a></span>"; if(data.card_buy_list[a].app_store_product=='true'){
                    str = str+"<span class='biz_sp_checkout'><a href='#' biz_app_store_product_id='"+data.card_buy_list[a].app_store_product_id+"' class='biz_btn_one_click_checkout btn btn-sm btn-full " +data.mobile.primary.button_color + " font-700 btn-margins rounded-sm mt-1 shadow-xl biz_btn'>Buy Now With 1-Click</a></span>";
                }
            str = str+"</div>";
        }
        ...
        function bind_buy_now_event(){
            ...
            $(".biz_btn_one_click_checkout").click(function() {
                ...
                obj.app_store_product_id=$(this).attr('biz_app_store_product_id');
