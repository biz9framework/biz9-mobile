    ...
    function bind_slide_show_list(item_list){
        ...
        for(var a=0;a<item_list.length;a++){
            ...
            str=str+"<div class='splide__slide'>"+
                ...
                item.sub_note
                +"</p>"+
                "<a href='product_list.html?category="+item.title+"&page_current=1' class='btn btn-s font-700 text-uppercase rounded-s mb-4 biz_btn'>Browse (" + item.item_count + " items)</a>"+
                "</div>"+
    ...
    function bind_category_list(item_list,page_current,page_count){
        ...
        for(var a=0;a<item_list.length;a++){
            ...
            str=str+"<div class='col-6'>"+
                "<a href='product_list.html?category="+item.title+"&page_current=1'><div class='card card-style m-0 mb-2 rounded-m' style='background-image: url("+item.photo_obj.mid_url+")' data-card-height='300'>"+
...
function set_page_product_list(data){
    ...
    function bind_list(item_list,page_current,page_count){
        ...
        for(a=0;a<item_list.length;a++){
            ...
            str=str+"<div class='col-6'>"+
                "<a href='product_detail.html?title_url="+item.title_url+"'><img src='"+item.photo_obj.mid_url+"' width='150' class='mx-auto'/></a>"+
        ...
        if(data.product.photofilename){
            ...
            for(a=0;a<data.product.photos.length;a++){
                str=str+"<div class='splide__slide'>"+
                    ...
                    "<img src='"+data.product.photos[a].photo_obj.mid_url+"' class='mx-auto pb-4' style='width:200px!important;'>"+
                    "</a></div>";
            }
            //slide-show-start
