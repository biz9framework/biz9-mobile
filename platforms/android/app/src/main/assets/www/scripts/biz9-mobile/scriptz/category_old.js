    ...
    function bind_list(item_list,page_current,page_count){
        ...
        for(a=0;a<item_list.length;a++){
            ...
            str = str+ "<div class='d-flex mb-3' id='biz_row_"+ item_list[a].tbl_id+"'>"+
                ...
                "</div>"+
                "<div class='biv_diz_list_title'><a href='dashboard_category.html?title_url="+item_list[a].title_url+"'><p class='ps-3 line-height-s color-theme mb-1'><b class='font-14'>"+item_list[a].title+"</b></p></a><div>"+
                "</div>"+
                "<p class='mb-0 ps-3 font-12 pt-0'>"+item_list[a].type_title+" " + edit_str+ " </p>"+
