    ...
    function bind_category_list(item_list,page_current,page_count){
        ...
        for(var a=0;a<item_list.length;a++){
            ...
            str=str+"<div class='col-6'>"+
                "<a href='service_list.html?category="+item.title+"&page_current=1'><div class='card card-style m-0 mb-2 rounded-m' style='background-image: url("+item.photo_obj.mid_url+")' data-card-height='150'>"+
    ...
    function bind_list(item_list,page_current,page_count){
        ...
        for(a=0;a<item_list.length;a++){
            ...
            if(String(item.visible_obj.service_visible_id) =='0'){
                visible_str="<p class='font-12 text-center mb-0 font-10 mt-n2 color-red'>"+item.visible_obj.service_status+"</p>";
            }else{
...
function set_page_service_detail(data){
    ...
    function hide_detail(){
        $('#biz_lbl_optiondiv0').hide();
        $('#biz_lbl_optiondiv1').hide();
        $('#biz_lbl_optiondiv2').hide();
        $('#biz_lbl_optiondiv3').hide();
        $('#biz_lbl_card_youtube').hide();
        $('#biz_lbl_card_description').hide();
    ...
    function bind_list(item_list,page_current,page_count){
        ...
        for(a=0;a<item_list.length;a++){
            ...
            str = str+ "<div class='d-flex mb-3' id='biz_row_"+ item.tbl_id+"'>"+
                ...
                "</div>"+
                "<div class='biz_diz_list_title'><a href='dashboard_service.html?title_url="+item.title_url+"'><p class='ps-3 line-height-s color-theme mb-1'><b class='font-11'>"+item.title+"</b></p></a><div>"+
                ...
                "<div class='biz_diz_list_edit'><a tbl_id='"+item.tbl_id +"' data_type='"+item.data_type +"' class='#' href='service_detail.html?title_url="+item.title_url+"'><i class='admin_edit_img fa fa-eye pe-2'></i></a>"+
                ...
                "<a tbl_id='"+item.tbl_id +"' data_type='"+item.data_type +"' class='#' href='"+sub_item_edit_url+"'><i class='admin_edit_img fa fa-info pe-2'></i></a>"+
